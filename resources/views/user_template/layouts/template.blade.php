...
<html lang="en">
   ...
   <body>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Man T -shirt</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img"><img src="{{ asset('home/images/dress-shirt-img.png') }}images/tshirt-img.png"></div>
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Man -shirt</h4>
                                 <p class="price_text">Price  <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img"><img src="{{ asset('home/') }}"></div>
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
      ...
      <script src="{{ asset('home/popper.min.js') }}"></script>
      <script src="{{ asset('home/bootstrap.bundle.min.js') }}"></script>
      <script src="{{ asset('home/jquery-3.0.0.min.js') }}"></script>
      <script src="{{ asset('home/plugin.js') }}"></script>
      <!-- sidebar {{ asset('home/') }}
